...
pub const PlaydateSys = extern struct {
    ...
    formatString: *const fn (ret: *[*]u8, fmt: [*:0]const u8, ...) callconv(.C) c_int,
    ...
    addMenuItem: *const fn (
        title: [*:0]const u8,
        callback: ?*const PDMenuItemCallbackFunction,
        userdata: ?*anyopaque,
    ...
    getMenuItemValue: *const fn (menuItem: *const PDMenuItem) callconv(.C) c_int,
    setMenuItemValue: *const fn (menuItem: *PDMenuItem, value: c_int) callconv(.C) void,
    getMenuItemTitle: *const fn (menuItem: *const PDMenuItem) callconv(.C) [*:0]const u8,
...
pub const PlaydateVideo = extern struct {
    ...
    getInfo: *const fn (*LCDVideoPlayer, ?*c_int, ?*c_int, ?*f32, ?*c_int, ?*c_int) callconv(.C) void,
...
pub const PlaydateFile = extern struct {
    ...
    read: *const fn (file: *SDFile, buf: [*]u8, len: c_uint) callconv(.C) c_int,
    write: *const fn (file: *SDFile, buf: [*]const u8, len: c_uint) callconv(.C) c_int,
...
//data is mono
pub const RecordCallback = fn (context: ?*anyopaque, buffer: [*c]i16, length: c_int) callconv(.C) c_int;
// len is # of samples in each buffer, function should return 1 if it produced output
pub const AudioSourceFunction = fn (context: ?*anyopaque, left: [*c]i16, right: [*c]i16, len: c_int) callconv(.C) c_int;
...
pub const PlaydateSoundChannel = extern struct {
    ...
    addCallbackSource: *const fn (*SoundChannel, *const AudioSourceFunction, ?*anyopaque, c_int) callconv(.C) ?*SoundSource,
...
pub const SynthRenderFunc = fn (userdata: ?*anyopaque, left: [*c]i32, right: [*c]i32, nsamples: c_int, rate: u32, drate: i32) callconv(.C) c_int;

// generator event callbacks

// len == -1 if indefinite
pub const SynthNoteOnFunc = fn (userdata: ?*anyopaque, note: MIDINote, velocity: f32, len: f32) callconv(.C) void;
...
pub const PlaydateSoundSynth = extern struct {
    ...
    setGenerator: *const fn (
        synth: ?*PDSynth,
        stereo: c_int,
        render: *const SynthRenderFunc,
        note_on: *const SynthNoteOnFunc,
        release: *const SynthReleaseFunc,
        set_param: *const SynthSetParameterFunc,
        dealloc: *const SynthDeallocFunc,
        userdata: ?*anyopaque,
    ) callconv(.C) void,
    setSample: *const fn (
        synth: ?*PDSynth,
...
pub const SequenceFinishedCallback = fn (seq: ?*SoundSequence, userdata: ?*anyopaque) callconv(.C) void;
...
pub const EffectProc = fn (e: ?*SoundEffect, left: [*c]i32, right: [*c]i32, nsamples: c_int, bufactive: c_int) callconv(.C) c_int;
...
pub const PlaydateSoundSource = extern struct {
    ...
    setFinishCallback: *const fn (c: *SoundSource, *const SndCallbackProc) callconv(.C) void,
};
...
pub const SignalStepFunc = fn (userdata: ?*anyopaque, ioframes: [*c]c_int, ifval: ?*f32) callconv(.C) f32;
// len = -1 for indefinite
pub const SignalNoteOnFunc = fn (userdata: ?*anyopaque, note: MIDINote, vel: f32, len: f32) callconv(.C) void;
// ended = 0 for note release, = 1 when note stops playing
pub const SignalNoteOffFunc = fn (userdata: ?*anyopaque, stopped: c_int, offset: c_int) callconv(.C) void;
pub const SignalDeallocFunc = fn (userdata: ?*anyopaque) callconv(.C) void;
pub const PlaydateSoundSignal = struct {
    newSignal: *const fn (step: *const SignalStepFunc, noteOn: *const SignalNoteOnFunc, noteOff: *const SignalNoteOffFunc, dealloc: *const SignalDeallocFunc, userdata: ?*anyopaque) callconv(.C) ?*PDSynthSignal,
...
pub const writeFunc = fn (userdata: ?*anyopaque, str: [*c]const u8, len: c_int) callconv(.C) void;
...
pub const PlaydateJSON = extern struct {
    initEncoder: *const fn (encoder: ?*JSONEncoder, write: *const writeFunc, userdata: ?*anyopaque, pretty: c_int) callconv(.C) void,
